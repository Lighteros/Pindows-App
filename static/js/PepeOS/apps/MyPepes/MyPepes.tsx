...
import windows from "@assets/png/pepecoin-logo.png";
import underConstruction from "@assets/webp/construction.webp";

interface MyComputerProps {
  onClose: () => void;
}

const MyPepes: FC<MyComputerProps> = ({ onClose }) => {
    ...
    <Div>
      ...
      <section className="com__function_bar">
        <div className="com__function_bar__button--disable">
          ...
          <span className="com__function_bar__text">Receive</span>
          <div className="com__function_bar__arrow" />
        </div>
        <div className="com__function_bar__button--disable">
          <img className="com__function_bar__icon" src={forward} alt="" />
          <span className="com__function_bar__text">Send</span>
          <div className="com__function_bar__arrow" />
        </div>
        ...
        <div className="com__function_bar__button">
          <img
            ...
            alt=""
          />
          <span className="com__function_bar__text">Tx History</span>
        </div>
        <div className="com__function_bar__button">
          <img
            className="com__function_bar__icon--normalize"
            ...
            alt=""
          />
          <span className="com__function_bar__text">Settings</span>
        </div>
      </section>
      <section className="com__address_bar">
        <div className="com__address_bar__title">Active Wallet</div>
        ...
        <div className="com__address_bar__go">
          ...
          <span className="com__address_bar__go__text">Send</span>
        </div>
      </section>
          ...
          <div className="com__content__right">
            <div className="com__content__right__card">
              <div className="com__content__right__card__header">
                The PepeOS Wallet is Under Construction
              </div>
