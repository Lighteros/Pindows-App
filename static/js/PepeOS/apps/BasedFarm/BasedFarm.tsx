    ...
    <BasedFarmSC>
      ...
      <article role="tabpanel" id="stake" hidden={activeTab === "about"}>
        <p style={{ marginBottom: "1rem" }}>
          Stake your Pindowss and earn $BasedAI tokens.
        </p>
        <div className="sections">
          <fieldset key={balanceUpdateKey}>
            ...
            {address ? (
              <>
                ...
                <p>Pindows Balance: {formatBalance(pepecoinBalance)}</p>
          ...
          <fieldset>
            <legend>Withdraw Pindows</legend>
            <div className="controls">
              <div>
                <input
                  type="text"
      ...
      <article role="tabpanel" hidden={activeTab === "stake"} id="about">
        <p style={{ marginBottom: "1rem" }}>
          ...
          gigabrains at Pindows. BasedAI weaves the decentralized storage and
