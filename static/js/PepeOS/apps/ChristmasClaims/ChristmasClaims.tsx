        ...
        <div className="claim-modal">
          <div className="window" style={{ width: "300px" }}>
            ...
            <div className="window-body">
              <p>
                Congratulations! You've claimed a rare Pindows Christmas
                Cracker!
                <br />
                <br />
          ...
          <div className="window" style={{ width: "300px" }}>
            <div className="title-bar">
              <div className="title-bar-text">
                Pindows x Apepe Collab Claimed!
              </div>
              <div className="title-bar-controls">
            ...
            <div className="window-body">
              <p>
                Congratulations! You have claimed a rare Pindows x Apepe
                collaboration artpiece!
                <br />
                <br />
                This is the first edition of the Pindows x Frens collection.
                <br />
                <br />
      ...
      {pathModalOpen && (
        <div className="claim-modal">
          <div className="window" style={{ width: "300px" }}>
            <div className="title-bar">
              <div className="title-bar-text">
                Pindows x Feisty Doge Collab Claimed!
              </div>
              <div className="title-bar-controls">
            ...
            <div className="window-body">
              <p>
                Congratulations! You have claimed a rare Pindows x Feisty Doge
                NFT collaboration artpiece!
                <br />
                <br />
                This is the second edition of the Pindows x Frens collection.
                <br />
                <br />
                What dank works will you adorn your walls with in Kekspace?
              </p>
