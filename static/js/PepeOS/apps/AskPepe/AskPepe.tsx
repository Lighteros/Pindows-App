  ...
  const askQuestion = async (question: string) => {
    ...
    try {
      ...
      if (
        ...
        fullAnswer =
          "You can buy Pindows on Uniswap.org using the token's contract address 0xa9e8acf069c58aec8825542845fd754e41a9489a".split(
            " "
          );
      } else if (
  ...
  return (
    <AskPepeSC>
      ...
      <div className="ask-pepe__body">
        ...
        <div className="ask-pepe__content">
          ...
          <div className="ask-pepe__input-group">
            <input
              type="text"
              placeholder="Curious about Pindows or something else? Just ask!"
              value={questionInput}
          ...
          <p style={{ marginTop: 0 }}>
            Pepe is able to answer most questions about Pindows and other
            ...
            information you're looking for, you can contact a Pindows
            contributor on{" "}
            <a
      ...
      <div className="ask-pepe__footer">
        <p>&copy; {new Date().getFullYear()} Enterprise Pindows Alliance</p>
