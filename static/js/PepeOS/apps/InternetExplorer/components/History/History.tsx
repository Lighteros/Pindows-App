    ...
    <HistorySC>
      ...
      {state === "credits" && (
        <div className="credits">
          ...
          <p>
            <span>
              Pindows was originally launched in 2016 by a group of gigabrained
            ...
            <span>
              ...
              the Pindows project under the name "Memetic" in order to avoid
              offending anyone.
              <br />
              <br />
            ...
            <span>
              ...
              Pindows project decided to migrate to the Ethereum blockchain to
              take advantage of EVM smart contracts.
              <br />
              <br />
              A nefarous project with the ticker $PEPE saw Pindows's
              announcement and frontran the project by launching their own PEPE
              token, even stealing the original Pindows logo, until they were
              forced to remove due to copyright.
              <br />
              <br />
              The one true Pindows has always been Pindows - and now the world
