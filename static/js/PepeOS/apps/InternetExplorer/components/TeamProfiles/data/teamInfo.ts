import bigBrain from "@assets/team/bigbrain.jpg";
...
export const teamInfo = [
  {
    ...
    status: ":-)",
    role: "Beloved King of meme culture",
  ...
  },
  {
    ...
    interests: {
      ...
      goals: [
        "Create an authentic Pindows powered Web3 ecosystem",
  ...
  },
  {
    ...
    about: {
      headline: "Big_Brain.Activate(BasedAI)",
      aboutMe: `My journey began early in software development and has landed in crypto, AI, and decentralized computational infrastructure. As an early pioneer of the arcane mysteries of blockchain and distributed ledger technology, I have witnessed the evolution of cryptocurrency from its infancy to the powerhouse it is today. My vast experience has equipped me with a profound understanding of the crypto landscape, making me a savant in the complex world of decentralized technology and blockchain development.
      \n
      I also am a grower of "magic" lettuce ;).`,
      lookingFor: `In a world dominated by tech giants, it’s my mission to democratize AI. My vision is to place the power of artificial intelligence into the hands of everyday people through decentralization. I believe AI should be a tool for mankind as an equalizer, not a weapon wielded against us for the benefit of a few corporations. I see a future where individuals and communities can harness AI for their unique needs, unlocking its potential to solve problems, fuel creativity, and improve lives.`,
    },
  },
  {
    ...
    about: {
      ...
      aboutMe: `Hi, My name is Moosa and I am the community manager for Pindows. I handle support and infrastructure, and am the POM POMS behind every community effort. Pindows started as just a group of like-minded friends. Throughout the years that commonality kept us together -- a love of Pepe, friends, crypto, art and more! At every turn, I will be there cheering on and leading the community to the promised land of Kek!`,
  ...
  },
  {
    ...
    interests: {
      general: ["Hiking", "Reading", "Cooking"],
      music: ["Smash Mouth", "Nickelback", "Enya"],
      memes: ["Pepe", "Doge", "Trollface", "Trump Gifs"],
      conspiracies: [
        "J.P. Morgan Sunk the Titanic",
        "Trudeau is Castro's Son",
        "Cold War never ended, communists went underground",
      ],
    },
    details: {
      status: "Autistic",
